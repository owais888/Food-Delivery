            ...
            <ScrollView style={{ backgroundColor: "#FFF" }}>
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Picker
                            ...
                            style={{ height: 50, width: 160, top: -70 }}
                ...
                <View style={{
                    ...
                    <Product
                        ...
                        title="Honey Chilli"
                        price="10.99"
                        onPress={() => this.props.navigation.navigate('Honey')}
                ...
                <View style={{
                    ...
                    <Product
                        ...
                        title="FishZinger"
                        price="12.99"
                        onPress={() => this.props.navigation.navigate('Fish')}
                    />
                    ...
                    <Product
                        ...
                        title="Beef Steak"
                        price="10.99"
                        onPress={() => this.props.navigation.navigate('Steak')}
                ...
                <View style={{
                    ...
                    <Product
                        ...
                        title="Club Sendwich"
                        price="10.99"
                        onPress={() => this.props.navigation.navigate('Sendwich')}
                ...
                <View style={{
                    ...
                    <Product
                        ...
                        title="Firehouse"
                        price="12.99"
                        onPress={() => this.props.navigation.navigate('Firehouse')}
                    />
                    ...
                    <Product
                        ...
                        price="10.99"
                        onPress={() => this.props.navigation.navigate('Biryani')}
                ...
                <View style={{
                    ...
                    <Product
                        ...
                        title="Gigantic Burger"
                        price="11.99"
                        onPress={() => this.props.navigation.navigate('Gigantic')}
                    ...
                    <Product
                        ...
                        title="Burrito"
                        price="10.99"
                        onPress={() => this.props.navigation.navigate('Twister')}
